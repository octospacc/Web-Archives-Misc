...
JSNES.prototype = {
    ...
    start: function() {
        ...
        if (this.rom !== null && this.rom.valid) {
            ...
            app.dialog.alert("There is no ROM loaded, or it is invalid.");
        }
    },
    ...
    loadRom: function(data) {
        ...
        if (this.rom.valid) {
            ...
            //app.dialog.alert("Successfully loaded. Ready to be started.");
        }
        else {
            app.dialog.alert("Invalid ROM!");
        }
