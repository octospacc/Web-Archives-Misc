...
JSNES.CPU.prototype = {
        ...
        switch(addrMode){
            case 0:{
                ...
                if(addr < 0x1FFF) {
                    ...
                    addr = this.loadFromCartridge(addr) + (this.loadFromCartridge((addr & 0xFF00) | (((addr & 0xFF) + 1) & 0xFF)) << 8);
                }
                break;
    ...
    doNonMaskableInterrupt: function(status){
        ...
        if((this.loadFromCartridge(0x2000) & 128) != 0) {
            ...
            this.REG_PC_NEW = this.loadFromCartridge(0xFFFA) | (this.loadFromCartridge(0xFFFB) << 8);
            this.REG_PC_NEW--;
        }
    },
    ...
    doResetInterrupt: function(){
        ...
        this.REG_PC_NEW = this.loadFromCartridge(0xFFFC) | (this.loadFromCartridge(0xFFFD) << 8);
        this.REG_PC_NEW--;
    },
    ...
    doIrq: function(status){
        ...
        this.REG_PC_NEW = this.loadFromCartridge(0xFFFE) | (this.loadFromCartridge(0xFFFF) << 8);
        this.REG_PC_NEW--;
    },
